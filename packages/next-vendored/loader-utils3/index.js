        ...
        l.sqrt = function () {
          ...
          if (A === 0 || A === 1 / 0) {
            ...
            e = new s(
              (A == 1 / 0
                ? '5e'
                : (A = A.toExponential()).slice(0, A.indexOf('e') + 1)) + n
            )
          } else {
            e = new s(A + '')
          }
