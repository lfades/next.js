  ...
  var __webpack_modules__ = {
    ...
    516: (e, t, a) => {
      ...
      function isstats(e) {
        ...
        return (
          ...
          typeof e === 'object' &&
          'ctime' in e &&
          r.call(e.ctime) === '[object Date]' &&
          'mtime' in e &&
          r.call(e.mtime) === '[object Date]' &&
          'ino' in e &&
          typeof e.ino === 'number' &&
          'size' in e &&
    ...
    701: (e, t, a) => {
      ...
      function SendStream(e, t, a) {
        ...
        this.req = e
        this._acceptRanges =
          i.acceptRanges !== undefined ? Boolean(i.acceptRanges) : true
        this._cacheControl =
          i.cacheControl !== undefined ? Boolean(i.cacheControl) : true
        ...
        this._extensions =
          i.extensions !== undefined
            ? normalizeList(i.extensions, 'extensions option')
            : []
        this._immutable =
          i.immutable !== undefined ? Boolean(i.immutable) : false
        this._index =
          i.index !== undefined
            ? normalizeList(i.index, 'index option')
            : ['index.html']
        this._lastModified =
          i.lastModified !== undefined ? Boolean(i.lastModified) : true
        ...
        this._maxage = !isNaN(this._maxage)
          ? Math.min(Math.max(0, this._maxage), E)
          : 0
        ...
        function isPreconditionFailure() {
          ...
          if (a) {
            ...
            return (
              !i ||
              (a !== '*' &&
                parseTokenList(a).every(function (e) {
      ...
      SendStream.prototype.redirect = function redirect(e) {
        ...
        var i = createHtmlDocument(
          'Redirecting',
          'Redirecting to <a href="' + s(a) + '">' + s(a) + '</a>'
        )
        t.statusCode = 301
