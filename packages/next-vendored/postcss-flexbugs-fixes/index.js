  ...
  var e = {
    ...
    526: (e, r, a) => {
      ...
      e.exports = function (e) {
        ...
        if (e.prop === 'flex' && a) {
          var s = u.decl({ prop: 'flex-grow', value: a[1], source: e.source })
          var t = u.decl({ prop: 'flex-shrink', value: a[2], source: e.source })
          var i = u.decl({ prop: 'flex-basis', value: a[3], source: e.source })
    ...
    136: (e, r, a) => {
      ...
      var s = a(578)
      var t = a(526)
      var i = ['none', 'auto', 'content', 'inherit', 'initial', 'unset']
      e.exports = function (e) {
        var r = Object.assign({ bug4: true, bug6: true, bug81a: true }, e)
        return {
