;(() => {
  var t = {
    ...
    161: (t, e, i) => {
      const { InvalidArgumentError: n } = i(854)
      class Argument {
        constructor(t, e) {
          this.description = e || ''
          this.variadic = false
        ...
        _concatValue(t, e) {
          if (e === this.defaultValue || !Array.isArray(e)) {
            return [t]
          }
          return e.concat(t)
        }
      ...
      function humanReadableArgName(t) {
        const e = t.name() + (t.variadic === true ? '...' : '')
    ...
    695: (t, e, i) => {
      ...
      const o = i(147)
      const a = i(282)
      const { Argument: h, humanReadableArgName: l } = i(161)
      const { CommanderError: u } = i(854)
      const { Help: c } = i(853)
      const { Option: p, DualOptions: d } = i(548)
      const { suggestSimilar: m } = i(324)
      class Command extends n {
        constructor(t) {
          ...
          this._outputConfiguration = {
            ...
            getOutHelpWidth: () =>
              a.stdout.isTTY ? a.stdout.columns : undefined,
            getErrHelpWidth: () =>
              a.stderr.isTTY ? a.stderr.columns : undefined,
            outputError: (t, e) => e(t),
          }
          this._hidden = false
        ...
        copyInheritedSettings(t) {
          ...
          this._helpOption = t._helpOption
          this._helpCommand = t._helpCommand
        ...
        configureHelp(t) {
          if (t === undefined) return this._helpConfiguration
          this._helpConfiguration = t
          return this
        }
        configureOutput(t) {
          if (t === undefined) return this._outputConfiguration
        ...
        addCommand(t, e) {
          ...
          this._registerCommand(t)
          t.parent = this
          t._checkForBrokenPassThrough()
          return this
        }
        createArgument(t, e) {
          return new h(t, e)
        ...
        addArgument(t) {
          ...
          if (
            ...
            t.parseArg === undefined
          ) {
            throw new Error(
              `a default value for a required argument is never used: '${t.name()}'`
            )
          }
          this.registeredArguments.push(t)
          return this
        }
        helpCommand(t, e) {
          if (typeof t === 'boolean') {
            this._addImplicitHelpCommand = t
            return this
          }
          t = t ?? 'help [command]'
          const [, i, n] = t.match(/([^ ]+) *(.*)/)
          const s = e ?? 'display help for command'
        ...
        _exit(t, e, i) {
          if (this._exitCallback) {
            this._exitCallback(new u(t, e, i))
          }
          a.exit(t)
        }
        action(t) {
        ...
        _callParseArg(t, e, i, n) {
          try {
            ...
            if (t.code === 'commander.invalidArgument') {
              const e = `${n} ${t.message}`
              this.error(e, { exitCode: t.exitCode, code: t.code })
            }
            throw t
          }
        }
        _registerOption(t) {
          const e =
            (t.short && this._findOption(t.short)) ||
            (t.long && this._findOption(t.long))
          if (e) {
            const i = t.long && this._findOption(t.long) ? t.long : t.short
            throw new Error(
              `Cannot add option '${t.flags}'${
        ...
        _registerCommand(t) {
          const knownBy = (t) => [t.name()].concat(t.aliases())
          const e = knownBy(t).find((t) => this._findCommand(t))
          if (e) {
            const i = knownBy(this._findCommand(e)).join('|')
            const n = knownBy(t).join('|')
            throw new Error(
        ...
        addOption(t) {
          ...
          if (t.negate) {
            ...
            if (!this._findOption(e)) {
              this.setOptionValueWithSource(
                i,
                t.defaultValue === undefined ? true : t.defaultValue,
                'default'
              )
            }
          } else if (t.defaultValue !== undefined) {
            this.setOptionValueWithSource(i, t.defaultValue, 'default')
          }
          const handleOptionValue = (e, n, s) => {
            if (e == null && t.presetArg !== undefined) {
              e = t.presetArg
            }
            const r = this.getOptionValue(i)
            if (e !== null && t.parseArg) {
              e = this._callParseArg(t, e, r, n)
            } else if (e !== null && t.variadic) {
              e = t._concatValue(e, r)
            }
            if (e == null) {
              if (t.negate) {
                e = false
              } else if (t.isBoolean() || t.optional) {
                e = true
              } else {
                e = ''
              }
        ...
        requiredOption(t, e, i, n) {
          return this._optionEx({ mandatory: true }, t, e, i, n)
        }
        ...
        setOptionValue(t, e) {
          return this.setOptionValueWithSource(t, e, undefined)
        }
        ...
        getOptionValueSourceWithGlobals(t) {
          ...
          this._getCommandAndAncestors().forEach((i) => {
            if (i.getOptionValueSource(t) !== undefined) {
              e = i.getOptionValueSource(t)
            }
          })
          return e
        }
        ...
        _executeSubCommand(t, e) {
          ...
          function findFile(t, e) {
            ...
            if (n.includes(r.extname(e))) return undefined
          ...
          let h = t._executableFile || `${this._name}-${t._name}`
          ...
          if (a.platform !== 'win32') {
            if (i) {
              ...
              c = s.spawn(a.argv[0], e, { stdio: 'inherit' })
            } else {
              c = s.spawn(h, e, { stdio: 'inherit' })
            }
          } else {
            e.unshift(h)
            e = incrementNodeInspectorPort(a.execArgv).concat(e)
            c = s.spawn(a.execPath, e, { stdio: 'inherit' })
          }
          if (!c.killed) {
          ...
          c.on('close', (t, e) => {
            ...
            if (!p) {
              ...
              p(new u(t, 'commander.executeSubCommandAsync', '(close)'))
            }
          })
          c.on('error', (e) => {
            if (e.code === 'ENOENT') {
        ...
        _checkNumberOfArguments() {
          this.registeredArguments.forEach((t, e) => {
            if (t.required && this.args[e] == null) {
        ...
        _processArguments() {
          const myParseArg = (t, e, i) => {
            let n = e
            if (e !== null && t.parseArg) {
              const s = `error: command-argument value '${e}' is invalid for argument '${t.name()}'.`
              n = this._callParseArg(t, e, i, s)
            }
            return n
          }
          ...
          this.registeredArguments.forEach((e, i) => {
            ...
            if (e.variadic) {
              if (i < this.args.length) {
                n = this.args.slice(i)
                if (e.parseArg) {
                  n = n.reduce((t, i) => myParseArg(e, i, t), e.defaultValue)
                }
              } else if (n === undefined) {
                n = []
              }
              ...
              n = this.args[i]
              if (e.parseArg) {
                n = myParseArg(e, n, e.defaultValue)
              }
            }
            t[i] = n
          })
        ...
        _chainOrCallHooks(t, e) {
          ...
          this._getCommandAndAncestors()
            .reverse()
            .filter((t) => t._lifeCycleHooks[e] !== undefined)
            .forEach((t) => {
        ...
        _chainOrCallSubCommandHook(t, e, i) {
          ...
          if (this._lifeCycleHooks[i] !== undefined) {
            this._lifeCycleHooks[i].forEach((t) => {
        ...
        _checkForMissingMandatoryOptions() {
          this._getCommandAndAncestors().forEach((t) => {
            t.options.forEach((e) => {
              if (
                e.mandatory &&
                t.getOptionValue(e.attributeName()) === undefined
              ) {
        ...
        _checkForConflictingLocalOptions() {
          const t = this.options.filter((t) => {
            ...
            if (this.getOptionValue(e) === undefined) {
              return false
            }
          ...
          while (s.length) {
            ...
            if (maybeOption(t)) {
              ...
              if (e) {
                if (e.required) {
                  const t = s.shift()
                  if (t === undefined) this.optionMissingArgument(e)
        ...
        _parseOptionsEnv() {
          this.options.forEach((t) => {
            if (t.envVar && t.envVar in a.env) {
              const e = t.attributeName()
              if (
                this.getOptionValue(e) === undefined ||
                ['default', 'config', 'env'].includes(
                  this.getOptionValueSource(e)
                )
              ) {
                if (t.required || t.optional) {
                  this.emit(`optionEnv:${t.name()}`, a.env[t.envVar])
                } else {
                  this.emit(`optionEnv:${t.name()}`)
                }
              }
            }
          })
        ...
        _parseOptionsImplied() {
          ...
          const hasCustomOptionValue = (t) =>
            this.getOptionValue(t) !== undefined &&
            !['default', 'implied'].includes(this.getOptionValueSource(t))
          this.options
            .filter(
              (e) =>
                e.implied !== undefined &&
                hasCustomOptionValue(e.attributeName()) &&
                t.valueFromOption(this.getOptionValue(e.attributeName()), e)
            )
            .forEach((t) => {
              Object.keys(t.implied)
                .filter((t) => !hasCustomOptionValue(t))
                .forEach((e) => {
        ...
        _conflictingOption(t, e) {
          const findBestOptionFromValue = (t) => {
            ...
            const n = this.options.find(
              (t) => t.negate && e === t.attributeName()
            )
            ...
            if (
              n &&
              ((n.presetArg === undefined && i === false) ||
                (n.presetArg !== undefined && i === n.presetArg))
            ) {
              return n
            }
            return s || t
          ...
          const getErrorMessage = (t) => {
            ...
            if (n === 'env') {
              return `environment variable '${e.envVar}'`
            }
            return `option '${e.flags}'`
          }
          const i = `error: ${getErrorMessage(
            t
          )} cannot be used with ${getErrorMessage(e)}`
        ...
        _excessArguments(t) {
          ...
          const e = this.registeredArguments.length
          const i = e === 1 ? '' : 's'
        ...
        version(t, e, i) {
          if (t === undefined) return this._version
          this._version = t
          e = e || '-V, --version'
        ...
        description(t, e) {
          if (t === undefined && e === undefined) return this._description
          this._description = t
          if (e) {
            this._argsDescription = e
          }
          return this
        }
        summary(t) {
          if (t === undefined) return this._summary
          this._summary = t
          return this
        }
        alias(t) {
          if (t === undefined) return this._aliases[0]
          let e = this
          if (
          ...
          const i = this.parent?._findCommand(t)
          if (i) {
            const e = [i.name()].concat(i.aliases()).join('|')
            throw new Error(
              `cannot add alias '${t}' to command '${this.name()}' as already have command '${e}'`
            )
          }
          e._aliases.push(t)
          return this
        ...
        aliases(t) {
          if (t === undefined) return this._aliases
        ...
        usage(t) {
          if (t === undefined) {
            ...
            const t = this.registeredArguments.map((t) => l(t))
            return []
              .concat(
        ...
        name(t) {
          if (t === undefined) return this._name
          this._name = t
          return this
        }
        nameFromFilename(t) {
        ...
        executableDir(t) {
          if (t === undefined) return this._executableDir
          this._executableDir = t
          return this
        }
        helpInformation(t) {
          const e = this.createHelp()
          if (e.helpWidth === undefined) {
            e.helpWidth =
              t && t.error
        ...
        _getHelpContext(t) {
          ...
          let i
          if (e.error) {
            i = (t) => this._outputConfiguration.writeErr(t)
          } else {
            i = (t) => this._outputConfiguration.writeOut(t)
          }
          e.write = t.write || i
          e.command = this
          return e
        ...
        outputHelp(t) {
          ...
          this._getCommandAndAncestors()
            .reverse()
            .forEach((t) => t.emit('beforeAllHelp', i))
        ...
        helpOption(t, e) {
          ...
          t = t ?? '-h, --help'
          e = e ?? 'display help for command'
          this._helpOption = this.createOption(t, e)
          return this
        }
        _getHelpOption() {
        ...
        help(t) {
          this.outputHelp(t)
          let e = a.exitCode || 0
          if (e === 0 && t && typeof t !== 'function' && t.error) {
            e = 1
          }
        ...
        addHelpText(t, e) {
          ...
          this.on(n, (t) => {
            ...
            if (typeof e === 'function') {
              i = e({ error: t.error, command: t.command })
            } else {
              i = e
            }
            if (i) {
      ...
      function incrementNodeInspectorPort(t) {
        return t.map((t) => {
          ...
          if ((s = t.match(/^(--inspect(-brk)?)$/)) !== null) {
            ...
            (s = t.match(/^(--inspect(-brk|-port)?)=([^:]+)$/)) !== null
          ) {
            e = s[1]
            if (/^\d+$/.test(s[3])) {
              n = s[3]
            ...
            (s = t.match(/^(--inspect(-brk|-port)?)=([^:]+):(\d+)$/)) !== null
          ) {
            e = s[1]
            i = s[3]
            n = s[4]
    ...
    853: (t, e, i) => {
      const { humanReadableArgName: n } = i(161)
      class Help {
        constructor() {
        ...
        visibleOptions(t) {
          ...
          const i = t._getHelpOption()
          if (i && !i.hidden) {
            const n = i.short && t._findOption(i.short)
            const s = i.long && t._findOption(i.long)
            if (!n && !s) {
              e.push(i)
            } else if (i.long && !s) {
              e.push(t.createOption(i.long, i.description))
            } else if (i.short && !n) {
              e.push(t.createOption(i.short, i.description))
            }
          }
          if (this.sortOptions) {
            e.sort(this.compareOptions)
          }
          return e
        }
        ...
        visibleArguments(t) {
          if (t._argsDescription) {
            t.registeredArguments.forEach((e) => {
              e.description =
                e.description || t._argsDescription[e.name()] || ''
            })
          }
          if (t.registeredArguments.find((t) => t.description)) {
            return t.registeredArguments
          }
          return []
        }
        subcommandTerm(t) {
          const e = t.registeredArguments.map((t) => n(t)).join(' ')
          return (
            t._name +
        ...
        longestSubcommandTermLength(t, e) {
          return e
            .visibleCommands(t)
            .reduce((t, i) => Math.max(t, e.subcommandTerm(i).length), 0)
        }
        longestOptionTermLength(t, e) {
          return e
            .visibleOptions(t)
            .reduce((t, i) => Math.max(t, e.optionTerm(i).length), 0)
        }
        ...
        longestArgumentTermLength(t, e) {
          return e
            .visibleArguments(t)
            .reduce((t, i) => Math.max(t, e.argumentTerm(i).length), 0)
        }
        commandUsage(t) {
          let e = t._name
          if (t._aliases[0]) {
        ...
        optionDescription(t) {
          ...
          if (t.defaultValue !== undefined) {
            const i =
              t.required ||
              t.optional ||
              (t.isBoolean() && typeof t.defaultValue === 'boolean')
            if (i) {
              e.push(
                `default: ${
          ...
          if (t.presetArg !== undefined && t.optional) {
            e.push(`preset: ${JSON.stringify(t.presetArg)}`)
          }
          if (t.envVar !== undefined) {
            e.push(`env: ${t.envVar}`)
          }
          if (e.length > 0) {
            return `${t.description} (${e.join(', ')})`
          }
          return t.description
        }
        ...
        formatHelp(t, e) {
          ...
          if (a.length > 0) {
            o = o.concat([e.wrap(a, n, 0), ''])
          }
          const h = e
            .visibleArguments(t)
            .map((t) => formatItem(e.argumentTerm(t), e.argumentDescription(t)))
          if (h.length > 0) {
            o = o.concat(['Arguments:', formatList(h), ''])
          }
          const l = e
            .visibleOptions(t)
            .map((t) => formatItem(e.optionTerm(t), e.optionDescription(t)))
          if (l.length > 0) {
          ...
          if (this.showGlobalOptions) {
            const i = e
              ...
              .map((t) => formatItem(e.optionTerm(t), e.optionDescription(t)))
            if (i.length > 0) {
              o = o.concat(['Global Options:', formatList(i), ''])
            }
          }
          const u = e
            .visibleCommands(t)
            .map((t) =>
              formatItem(e.subcommandTerm(t), e.subcommandDescription(t))
            )
          if (u.length > 0) {
    ...
    548: (t, e, i) => {
      ...
      class Option {
        ...
        implies(t) {
          ...
          this.implied = Object.assign(this.implied || {}, e)
          return this
        }
        env(t) {
          this.envVar = t
      ...
      class DualOptions {
        constructor(t) {
          ...
          this.negativeOptions.forEach((t, e) => {
            if (this.positiveOptions.has(e)) {
              this.dualOptions.add(e)
            }
          })
        }
        valueFromOption(t, e) {
    ...
    324: (t, e) => {
      ...
      function editDistance(t, e) {
        if (Math.abs(t.length - e.length) > i)
  ...
  ;(() => {
    var t = i
    const { Argument: e } = __nccwpck_require__(161)
    const { Command: n } = __nccwpck_require__(695)
    const { CommanderError: s, InvalidArgumentError: r } =
      __nccwpck_require__(854)
    const { Help: o } = __nccwpck_require__(853)
    const { Option: a } = __nccwpck_require__(548)
    t.program = new n()
    t.createCommand = (t) => new n(t)
    t.createOption = (t, e) => new a(t, e)
    t.createArgument = (t, i) => new e(t, i)
    t.Command = n
    t.Option = a
    t.Argument = e
    t.Help = o
    t.CommanderError = s
    t.InvalidArgumentError = r
    t.InvalidOptionArgumentError = r
  })()
  module.exports = i
})()
