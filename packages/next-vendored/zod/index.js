;(() => {
  ...
  var e = {
    ...
    973: (e, t, s) => {
      ...
      ZodSymbol.create = (e) =>
        new ZodSymbol({ typeName: y.ZodSymbol, ...processCreateParams(e) })
      ...
      t.ZodNull = ZodNull
      ZodNull.create = (e) =>
        new ZodNull({ typeName: y.ZodNull, ...processCreateParams(e) })
      ...
      t.ZodAny = ZodAny
      ZodAny.create = (e) =>
        new ZodAny({ typeName: y.ZodAny, ...processCreateParams(e) })
      ...
      ZodUnknown.create = (e) =>
        new ZodUnknown({ typeName: y.ZodUnknown, ...processCreateParams(e) })
      ...
      t.ZodNever = ZodNever
      ZodNever.create = (e) =>
        new ZodNever({ typeName: y.ZodNever, ...processCreateParams(e) })
      ...
      t.ZodVoid = ZodVoid
      ZodVoid.create = (e) =>
        new ZodVoid({ typeName: y.ZodVoid, ...processCreateParams(e) })
      ...
      class ZodEffects extends ZodType {
        ...
        _parse(e) {
          ...
          if (r.type === 'preprocess') {
            ...
            if (s.common.issues.length) {
              return { status: 'dirty', value: s.data }
            }
            if (s.common.async) {
      ...
      class ZodCatch extends ZodType {
        _parse(e) {
          const { ctx: t } = this._processInputParams(e)
          const s = { ...t, common: { ...t.common, issues: [] } }
      ...
      t.ZodNaN = ZodNaN
      ZodNaN.create = (e) =>
        new ZodNaN({ typeName: y.ZodNaN, ...processCreateParams(e) })
      ...
      class ZodPipeline extends ZodType {
        ...
        static create(e, t) {
          return new ZodPipeline({ in: e, out: t, typeName: y.ZodPipeline })
        }
      }
            ...
            if (!e(r)) {
              const e =
                typeof t === 'function'
                  ...
                  : t
              const i =
                (o = (n = e.fatal) !== null && n !== void 0 ? n : s) !== null &&
                o !== void 0
                  ? o
                  : true
              const d = typeof e === 'string' ? { message: e } : e
              a.addIssue({ code: 'custom', ...d, fatal: i })
            }
          })
