;(function () {
  var e = {
    ...
    167: function (e, t, r) {
      ...
      var n = r(23),
        o = n.codes,
        i = o.ERR_AMBIGUOUS_ARGUMENT,
        a = o.ERR_INVALID_ARG_TYPE,
        c = o.ERR_INVALID_ARG_VALUE,
        u = o.ERR_INVALID_RETURN_VALUE,
        f = o.ERR_MISSING_ARGS
      var s = r(545)
      var l = r(177),
        p = l.inspect
      var y = r(177).types,
        g = y.isPromise,
        v = y.isRegExp
      var d = Object.assign ? Object.assign : r(604).assign
      ...
      function ok() {
        ...
        innerOk.apply(void 0, [ok, t.length].concat(t))
      }
      x.ok = ok
      ...
      function expectedException(e, t, r, n) {
        if (typeof t !== 'function') {
          ...
          if (arguments.length === 2) {
            throw new a('expected', ['Function', 'RegExp'], t)
          }
      ...
      function waitForActual(e) {
        return Promise.resolve().then(function () {
          ...
          if (typeof e === 'function') {
            ...
            throw new a('promiseFn', ['Function', 'Promise'], e)
          }
      ...
      x.throws = function throws(e) {
        ...
        expectsError.apply(void 0, [throws, getActual(e)].concat(r))
      }
      x.rejects = function rejects(e) {
        ...
        return waitForActual(e).then(function (e) {
          return expectsError.apply(void 0, [rejects, e].concat(r))
        })
      }
      x.doesNotThrow = function doesNotThrow(e) {
        ...
        expectsNoError.apply(void 0, [doesNotThrow, getActual(e)].concat(r))
      }
      x.doesNotReject = function doesNotReject(e) {
        ...
        return waitForActual(e).then(function (e) {
          return expectsNoError.apply(void 0, [doesNotReject, e].concat(r))
        })
      }
      ...
      function strict() {
        ...
        innerOk.apply(void 0, [strict, t.length].concat(t))
      }
      x.strict = d(strict, x, {
        equal: x.strictEqual,
    ...
    545: function (e, t, r) {
      ...
      var n = r(177),
        o = n.inspect
      var i = r(23),
        a = i.codes.ERR_INVALID_ARG_TYPE
      ...
      function createErrDiff(e, t, r) {
        ...
        if (v.length === 1 && d.length === 1 && v[0] !== d[0]) {
          ...
          if (m <= p) {
            if (
              (_typeof(e) !== 'object' || e === null) &&
              (_typeof(t) !== 'object' || t === null) &&
              (e !== 0 || t !== 0)
            ) {
              return (
                ''.concat(l[r], '\n\n') +
        ...
        function AssertionError(e) {
          ...
          if (r != null) {
            t = _possibleConstructorReturn(
              this,
              _getPrototypeOf(AssertionError).call(this, String(r))
            )
          } else {
        ...
        _createClass(AssertionError, [
          ...
          },
          {
            ...
            value: function value(e, t) {
              return o(
                this,
                _objectSpread({}, t, { customInspect: false, depth: 0 })
              )
            },
          },
        ])
        ...
        var o = (function (t) {
          ...
          function NodeError(t, r, n) {
            ...
            o = _possibleConstructorReturn(
              this,
              _getPrototypeOf(NodeError).call(this, getMessage(t, r, n))
            )
            o.code = e
            return o
          }
    ...
    176: function (e, t, r) {
      ...
      function areEqualArrayBuffers(e, t) {
        return (
          ...
          compare(new Uint8Array(e), new Uint8Array(t)) === 0
        )
      }
        ...
        if (o !== null) {
          ...
          for (var y = 0; y < p.length; y++) {
            ...
            if (_typeof(f) === 'object' && f !== null) {
              ...
              !r &&
              (!e.has(f) || !innerDeepEqual(e.get(f), v, false, n)) &&
              !mapHasEqualEntry(o, e, f, v, false, n)
            ) {
              return false
            }
          }
    ...
    69: function (e, t, r) {
      ...
      var arePropertyDescriptorsSupported = function () {
        var e = {}
        try {
          c(e, 'x', { enumerable: false, value: e })
          for (var t in e) {
            return false
          }
          return e.x === e
    ...
    604: function (e) {
      ...
      e.exports = { assign: assign, polyfill: polyfill }
    },
    144: function (e) {
      var t = Object.prototype.hasOwnProperty
    ...
    157: function (e) {
      ...
      var o = function isArguments(e) {
        ...
        return (
          ...
          r.call(e.callee) === '[object Function]'
        )
      }
      var i = (function () {
        return n(arguments)
    ...
    718: function (e, t, r) {
      ...
      var c = r(171)
      var u = n(a(), Number)
      o(u, { getPolyfill: a, implementation: i, shim: c })
      e.exports = u
    },
    625: function (e, t, r) {
      'use strict'
      ...
      e.exports = function isArguments(e) {
        ...
        if (!n) {
          n =
            ...
            typeof e.length === 'number' &&
            e.length >= 0 &&
            t.call(e.callee) === '[object Function]'
        }
        return n
      }
    },
    ...
    584: function (e, t, r) {
      ...
      function isAnyArrayBuffer(e) {
        return (
          ...
          (isArrayBuffer(e) || isSharedArrayBuffer(e))
        )
      }
