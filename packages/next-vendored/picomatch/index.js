  ...
  var t = {
    ...
    697: (t, e, u) => {
      ...
      const parse = (t, e) => {
        ...
        const f = { type: 'bos', value: '', output: u.prepend || '' }
        const A = [f]
        const _ = u.capture ? '' : '?:'
        ...
        const extglobOpen = (t, e) => {
          const n = { ...E[e], conditions: 1, inner: '' }
          n.prev = B
          n.parens = m.parens
          n.output = m.output
          const o = (u.capture ? '(' : '') + n.open
          increment('parens')
          push({ type: t, value: e, output: m.output ? '' : C })
          push({ type: 'paren', extglob: true, value: M(), output: o })
          w.push(n)
        }
        const extglobClose = (t) => {
          ...
          if (t.type === 'negate') {
            ...
            if (
              ...
              const u = parse(o, { ...e, fastpaths: false }).output
              n = t.close = `)${u})${s})`
            }
            if (t.prev.type === 'bos') {
        ...
        while (!eos()) {
          ...
          if (G === '}') {
            ...
            push({ type: 'brace', value: G, output: e })
            decrement('braces')
            N.pop()
            continue
          }
          ...
          if (G === ',') {
            ...
            push({ type: 'comma', value: G, output: t })
            continue
          }
          if (G === '/') {
          ...
          if (G === '?') {
            ...
            if (B && B.type === 'paren') {
              ...
              push({ type: 'text', value: G, output: e })
              continue
            }
          ...
          const n = { type: 'star', value: G, output: k }
          if (u.bash === true) {
            n.output = '.*?'
      ...
      const picomatch = (t, e, u = false) => {
        ...
        const matcher = (u, n = false) => {
          const {
            ...
            match: c,
            output: p,
          } = picomatch.test(u, r, e, { glob: t, posix: s })
          const l = {
            glob: t,
            state: a,
            regex: r,
