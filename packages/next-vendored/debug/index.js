    ...
    178: (e, t, r) => {
      ...
      function envForceColor() {
        if ('FORCE_COLOR' in c) {
          ...
          return c.FORCE_COLOR.length === 0
            ? 1
            : Math.min(Number.parseInt(c.FORCE_COLOR, 10), 3)
        }
      }
      ...
      function supportsColor(e, { streamIsTTY: t, sniffFlags: r = true } = {}) {
        ...
        if ('TERM_PROGRAM' in c) {
          const e = Number.parseInt(
            (c.TERM_PROGRAM_VERSION || '').split('.')[0],
            10
          )
      ...
      e.exports = {
        ...
        stdout: getSupportLevel({ isTTY: n.isatty(1) }),
        stderr: getSupportLevel({ isTTY: n.isatty(2) }),
      }
    },
    37: (e) => {
      'use strict'
