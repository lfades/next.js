  ...
  var e = {
    ...
    9374: function (e, t, r) {
      ...
      Node.prototype._decodeGeneric = function decodeGeneric(e, t, r) {
        ...
        if (e === 'seqof' || e === 'setof')
          return this._decodeList(t, e, i.args[0], r)
        else if (/str$/.test(e)) return this._decodeStr(t, e, r)
        else if (e === 'objid' && i.args)
          return this._decodeObjid(t, i.args[0], i.args[1], r)
        else if (e === 'objid') return this._decodeObjid(t, null, null, r)
        else if (e === 'gentime' || e === 'utctime')
          return this._decodeTime(t, e, r)
          ...
          return this._decodeInt(t, i.args && i.args[0], r)
        if (i.use !== null) {
      ...
      Node.prototype._encodeValue = function encode(e, t, r) {
        ...
        if (n.explicit !== null)
          a = this._encodeComposite(n.explicit, false, 'context', a)
        return a
      }
    ...
    7804: function (e, t, r) {
      ...
      DERNode.prototype._skipDefault = function skipDefault(e, t, r) {
        ...
        for (n = 0; n < a.length; n++)
          if (a[n] !== i.defaultBuffer[n]) return false
        return true
      }
    ...
    711: function (e, t, r) {
      ...
      ;(function (e, t) {
        ...
        FFTM.prototype.normalize13b = function normalize13b(e, t) {
          ...
          for (var i = 0; i < t / 2; i++) {
            var n =
              Math.round(e[2 * i + 1] / t) * 8192 + Math.round(e[2 * i] / t) + r
            e[i] = n & 67108863
            if (n < 67108864) {
              r = 0
            } else {
        ...
        BN.prototype._wordDiv = function _wordDiv(e, t) {
          ...
          for (var c = o - 1; c >= 0; c--) {
            var l =
              (i.words[n.length + c] | 0) * 67108864 +
              (i.words[n.length + c - 1] | 0)
      ...
      AES.prototype._reset = function () {
        ...
        for (var d = 0; d < i; d++) {
          ...
          if (d < 4 || c <= 4) {
            ...
            u[d] =
              a.INV_SUB_MIX[0][a.SBOX[l >>> 24]] ^
              a.INV_SUB_MIX[1][a.SBOX[(l >>> 16) & 255]] ^
              a.INV_SUB_MIX[2][a.SBOX[(l >>> 8) & 255]] ^
              a.INV_SUB_MIX[3][a.SBOX[l & 255]]
          }
        }
        this._nRounds = r
        this._keySchedule = s
      ...
      t.encrypt = function (e, t, r) {
        ...
        while (t.length) {
          ...
          if (e._cache.length <= t.length) {
            a = e._cache.length
            n = i.concat([n, encryptStart(e, t.slice(0, a), r)])
            t = t.slice(a)
          } else {
            n = i.concat([n, encryptStart(e, t, r)])
            break
          }
        }
        return n
    ...
    3361: function (e, t, r) {
      ...
      t.encrypt = function (e, t) {
        ...
        e._cache = n.concat([e._cache, n.allocUnsafe(r * s)])
        for (var o = 0; o < r; o++) {
          var h = getBlock(e)
          var u = a + o * s
    ...
    3412: function (e, t, r) {
      ...
      t.encrypt = function (e, t) {
        while (e._cache.length < t.length) {
          e._cache = Buffer.concat([e._cache, getBlock(e)])
        }
    ...
    8996: function (e, t, r) {
      ...
      function createDecipheriv(e, t, r) {
        ...
        if (s[e]) return new i({ key: t, iv: r, mode: e, decrypt: true })
        throw new TypeError('invalid suite type')
      }
      function getCiphers() {
    ...
    5238: function (e, t, r) {
      ...
      function DES(e) {
        ...
        if (t === 'des-ede' || t === 'des-ede-cbc') {
          a = s.concat([a, a.slice(0, 8)])
        }
        var h = e.iv
        if (!s.isBuffer(h)) {
          h = s.from(h)
        }
        this._des = r.create({ key: a, iv: h, type: n })
      }
    ...
    4013: function (e, t, r) {
      ...
      function dsaVerify(e, t, r) {
        ...
        var v = o
          ...
          .fromRed()
          .mul(h.toRed(l).redPow(c.mul(p).mod(a)).fromRed())
          .mod(i)
          .mod(a)
        return v.cmp(c) === 0
      }
    ...
    1016: function (e, t, r) {
      ...
      var o = [1, 1, 2, 2, 2, 2, 2, 2, 1, 2, 2, 2, 2, 2, 2, 1]
    ...
    2705: function (e, t, r) {
      ...
      EdwardsCurve.prototype.pointFromX = function pointFromX(e, t) {
        ...
        var o = s.redSqrt()
        if (o.redSqr().redSub(s).cmp(this.zero) !== 0)
    ...
    4720: function (e, t, r) {
      ...
      ShortCurve.prototype._getEndomorphism = function _getEndomorphism(e) {
        ...
        return { beta: t, lambda: r, basis: s }
      }
    ...
    4088: function (e, t, r) {
      ...
      function EC(e) {
        ...
        if (e instanceof s.PresetCurve) e = { curve: e }
      ...
      EC.prototype.sign = function sign(e, t, r, a) {
        ...
        for (var l = 0; true; l++) {
          ...
          return new d({ r: m, s: y, recoveryParam: g })
        }
      }
    ...
    8511: function (e, t, r) {
      ...
      EDDSA.prototype.sign = function sign(e, t) {
        ...
        return this.makeSignature({ R: n, S: h, Rencoded: a })
      }
    ...
    1525: function (e, t, r) {
      ...
      SHA256.prototype._update = function _update(e, t) {
        ...
        for (var i = 0; i < 16; i++) r[i] = e[t + i]
        for (; i < r.length; i++)
          r[i] = h(b(r[i - 2]), r[i - 7], v(r[i - 15]), r[i - 16])
        var n = this.h[0]
        var a = this.h[1]
        var m = this.h[2]
        var y = this.h[3]
    ...
    263: function (e, t, r) {
      ...
      function join32(e, t, r, n) {
        ...
        for (var o = 0, h = t; o < s.length; o++, h += 4) {
          var u
          if (n === 'big')
            u = (e[h] << 24) | (e[h + 1] << 16) | (e[h + 2] << 8) | e[h + 3]
    ...
    9902: function (e, t, r) {
      ...
      function parseKeys(e) {
        ...
        switch (n) {
          case 'CERTIFICATE':
            u = i.certificate.decode(s, 'der').tbsCertificate
          ...
          case 'PUBLIC KEY':
            ...
            switch (o) {
              ...
              case '1.2.840.10045.2.1':
                ...
                return { type: 'ec', data: u }
              case '1.2.840.10040.4.1':
                u.algorithm.params.pub_key = i.DSAparam.decode(
                  u.subjectPublicKey.data,
                  'der'
                )
                return { type: 'dsa', data: u.algorithm.params }
              default:
            ...
            switch (o) {
              ...
              case '1.2.840.10045.2.1':
                return {
                  ...
                  privateKey: i.ECPrivateKey.decode(u.subjectPrivateKey, 'der')
                    .privateKey,
                }
              case '1.2.840.10040.4.1':
                u.algorithm.params.priv_key = i.DSAparam.decode(
                  u.subjectPrivateKey,
                  'der'
                )
                return { type: 'dsa', params: u.algorithm.params }
              default:
                throw new Error('unknown key id ' + o)
            }
            throw new Error('unknown key type ' + n)
          ...
          case 'EC PRIVATE KEY':
            ...
            return { curve: s.parameters.value, privateKey: s.privateKey }
          default:
            throw new Error('unknown key type ' + n)
        }
      }
    ...
    4978: function (e, t, r) {
      ...
      if (
        !i.pbkdf2Sync ||
        i.pbkdf2Sync.toString().indexOf('keylen, digest') === -1
      ) {
        t.pbkdf2Sync = r(2127)
        t.pbkdf2 = r(9601)
      } else {
    ...
    9601: function (e, t, r) {
      ...
      function checkNative(e) {
        ...
        h = h || i.alloc(8)
        var t = browserPbkdf2(h, h, 10, 128, e)
          .then(function () {
            return true
          })
          .catch(function () {
      ...
      function browserPbkdf2(e, t, r, n, a) {
        return u
          ...
          .then(function (e) {
            return u.deriveBits(
              { name: 'PBKDF2', salt: t, iterations: r, hash: { name: a } },
              e,
              n << 3
            )
          })
    ...
    7007: function (e) {
      ...
      if (process.browser) {
        ...
        var r = parseInt(process.version.split('.')[0].slice(1), 10)
        t = r >= 6 ? 'utf-8' : 'binary'
      } else {
        t = 'utf-8'
      }
    ...
    5520: function (e, t, r) {
      ...
      e.exports = function (e, t) {
        ...
        while (r.length < t) {
          s = i2ops(a++)
          r = n.concat([r, i('sha1').update(e).update(s).digest()])
        }
        return r.slice(0, t)
      }
      function i2ops(e) {
    ...
    4366: function (e, t, r) {
      ...
      function pkcs1(e, t, r) {
        ...
        var s = t.slice(2, n - 1)
        if (
          (i.toString('hex') !== '0002' && !r) ||
          (i.toString('hex') !== '0001' && r)
        ) {
          a++
        }
        if (s.length < 8) {
    ...
    3995: function (e, t, r) {
      ...
      function oaep(e, t) {
        ...
        var v = r - d - 1
        var b = n(d)
        var m = o(c.concat([u, p, c.alloc(1, 1), t], v), s(b, v))
        var y = o(b, s(m, d))
        return new h(c.concat([c.alloc(1), y, m], r))
      }
      function pkcs1(e, t, r) {
        var i = t.length
        ...
        return new h(c.concat([c.from([0, r ? 1 : 2]), a, c.alloc(1), t], n))
      }
      function nonZero(e) {
    ...
    6445: function (e, t, r) {
      ...
      if ((o && o.getRandomValues) || !process.browser) {
    ...
    1709: function (e, t, r) {
      ...
      Readable.prototype.pipe = function (e, t) {
        ...
        function cleanup() {
          ...
          h = true
          if (i.awaitDrain && (!e._writableState || e._writableState.needDrain))
            o()
        }
        r.on('data', ondata)
        function ondata(t) {
          ...
          if (n === false) {
            if (
              ((i.pipesCount === 1 && i.pipes === e) ||
                (i.pipesCount > 1 && indexOf(i.pipes, e) !== -1)) &&
              !h
            ) {
    ...
    7337: function (e, t, r) {
      ...
      var c = r(4646).q,
        ...
        b = c.ERR_STREAM_CANNOT_PIPE,
        m = c.ERR_STREAM_DESTROYED,
    ...
    3225: function (e, t, r) {
      ...
      var c = [0, 1518500249, 1859775393, 2400959708, 2840853838]
      var l = [1352829926, 1548603684, 1836072691, 2053994217, 0]
      function RIPEMD160() {
        a.call(this, 64)
        this._a = 1732584193
        this._b = 4023233417
    ...
    1843: function (e, t, r) {
      ...
      Sha256.prototype._update = function (e) {
        ...
        for (; c < 64; ++c)
          t[c] =
            (gamma1(t[c - 2]) + t[c - 7] + gamma0(t[c - 15]) + t[c - 16]) | 0
        for (var l = 0; l < 64; ++l) {
